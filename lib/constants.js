...
export const OPERATIONAL_LOG_ACTION_LABELS = {
  ...
  reklamacja_realizacja_do_updated_from_sms_confirmation:
    "Zaktualizowano termin realizacji po potwierdzeniu SMS",
  ...
  route_sms_rejection_alert_acknowledged:
    "Potwierdzono informacje o odmowie terminu z SMS",
  ...
  route_cancelled: "Usunieto zaplanowana trase",
  ...
  route_sms_confirmation_rejected: "Klient odrzucil termin z SMS",
