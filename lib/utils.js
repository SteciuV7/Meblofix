...
function formatActionWithOptionalDate(message, dateValue, withTime = true) {
  const dateLabel = formatLogDate(dateValue, withTime);
...
export function formatOperationalLogAction(log, { withTime = true } = {}) {
