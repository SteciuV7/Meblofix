...
alter table if exists public.trasy
  add column if not exists return_base_address_snapshot text,
...
begin
  insert into public.trasy (
    ...
    return_base_lat_snapshot,
    return_base_lon_snapshot,
    total_distance_m,
    total_duration_s,
    notes
  )
  values (
    ...
    nullif(p_route->>'return_base_address_snapshot', ''),
    nullif(p_route->>'return_base_lat_snapshot', '')::numeric,
    nullif(p_route->>'return_base_lon_snapshot', '')::numeric,
